...
validationdata = testGenerator.flow_from_directory(
    "../data/test", target_size=(100, 100), batch_size=64, class_mode='binary')

checkpointer = ModelCheckpoint(
    filepath="weight.hdf5", save_best_only=True, save_weights_only=True)
